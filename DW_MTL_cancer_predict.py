...
# -*- coding: utf-8 -*-
"""
DW-MTL cancer RTV batch prediction script.

This script is a simplified version of the original molecular-graph interpretation
notebook. It keeps only the functions needed for cancer RTV prediction on new compounds:
...
5. Save OSF, ISF and IUR prediction results to a CSV file.
...
python DW_MTL_cancer_predict.py
...
OUTPUT_CSV = r"C:\Users\Administrator\Desktop\DW-MTL-main\data\test chemicals_prediction.csv"
FAILED_CSV = r"/path/to/cancer_failed_smiles.csv"
...
# 只保留致癌主任务输出，不输出分类辅助任务。
MAIN_TASK_NAMES = ["OSF", "ISF", "IUR"]
...
MODEL_JOBS = [
    {
        # 输出列名将为 OSF, ISF, IUR；如果希望加前缀，可改为 "cancer"
        "name": "",
        "model_path": r"C:\Users\Administrator\Desktop\DW-MTL-main\DW-MTL models\DW-MTL-cancer.pth",
        "config_path": r"C:\Users\Administrator\Desktop\DW-MTL-main\DW-MTL models\DW-MTL-cancer.pkl",
    },
]
