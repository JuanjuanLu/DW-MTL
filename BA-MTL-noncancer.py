...
args['select_task_list'] = ['RfD', 'RfC', 'BMD', '1a2', '2c19', '2c9', '2d6', '3a4']  # change
args['select_task_index'] = []
args['classification_num'] = 0
args['regression_num'] = 0
args['all_task_list'] = ['RfD', 'RfC', 'BMD', '1a2', '2c19', '2c9', '2d6', '3a4']  # change
...
for task in args['select_task_list']:
    if task in ['1a2', '2c19', '2c9', '2d6', '3a4']:
        args['classification_num'] = args['classification_num'] + 1
    if task in ['RfD', 'RfC', 'BMD']:
